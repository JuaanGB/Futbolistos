...
public class VentanaCurso extends JFrame {
	...
	public VentanaCurso(SesionCurso sesionCurso) {
		...
		setSize(345, 500);
		setMinimumSize(new Dimension(345, 500));
		...
		// Se aumenta el ancho de la columna central para que el botón "Guardar estado"
		// luzca más grande
		...
		// Se mantiene la etiqueta de pistas restantes (el botón de pista se encuentra
		// en otro lugar, debajo de las respuestas)
		lblPistasRestantes = FactoriaComponentes.crearLabel("Pistas restantes: " + sesionCurso.getPistasRestantes());
		...
		lblProgreso = FactoriaComponentes.crearLabel(
